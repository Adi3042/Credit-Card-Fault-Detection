...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            print(f"best model name {best_model_name} and score: {best_model_score*100}")
            logging.info(f"Best model name {best_model_name} and score: {best_model_score*100}")
            ...
            print(f"Saving model at path: {self.model_trainer_config.trained_model_path}")
            ...
            print("Awesome! Training completed!!!\nTrained model score : ", best_model_score*100)
